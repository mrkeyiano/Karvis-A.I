...
public class FLAC_FileEncoder {
	 ...
	 * characteristics(number of channels, sample rate, and sample size), will be set to match the
	 * input file at encode time, so needn't be set in the given StreamConfiguration object.
	 * @param config
	...
	private Status openStream() throws IOException {
	...
	/**
	 * Get the total number of samples encoded in last encode. This is here primarily for use as a
